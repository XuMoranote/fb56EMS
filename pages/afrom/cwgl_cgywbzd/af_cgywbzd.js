// pages/afrom/cwgl_cgywbzd/af_cgywbzd.js
const app = getApp();
...
Page({
  ...
  data: {
    //工作流类型
    gzllx_index: 0,
    gzllx_array: ['请选择', '自购报销工作流', '集采费用报销工作流'],
    gzllx2_index: 0,
    gzllx2_array: [],
    gzllx3_index: 0,
    gzllx3_array: [],
  ...
  onSubmit(e) {
    ...
    //获取菜单ID
    var menuid = munePage.GetMenuCode("采购业务报账单");
    if (Number(menuid) <= 0) {
      self.setData({
        error: '获取菜单ID异常！'
      });
    ...
    let paramData = JSON.stringify({
      ...
      // "_flowid": "73ac8796-6615-4778-a50f-ba95606dd1c7",
      "SubTitle": "FB-CGYWBZD-",
